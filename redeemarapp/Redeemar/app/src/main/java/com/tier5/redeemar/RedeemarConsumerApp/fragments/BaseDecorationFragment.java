...
public abstract class BaseDecorationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_banked, container, false);
        mList = (RecyclerView) view.findViewById(R.id.main_recycler);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        final DividerDecoration divider = new DividerDecoration.Builder(this.getActivity())
                .setHeight(R.dimen.item_padding)
                .setPadding(R.dimen.item_padding)
                .setColorResource(R.color.md_blue_500)
                .build();
