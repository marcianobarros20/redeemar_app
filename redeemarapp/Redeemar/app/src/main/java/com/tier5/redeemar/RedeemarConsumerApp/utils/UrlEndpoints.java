...
public class UrlEndpoints {
    ...
    public static final String serverBaseUrl = "http://www.redeemar.com/";
    ...
    public static final String URL_SEARCH_BEACON     =  serverBaseUrl+"admin/public/index.php/bridge/findbeacon";
