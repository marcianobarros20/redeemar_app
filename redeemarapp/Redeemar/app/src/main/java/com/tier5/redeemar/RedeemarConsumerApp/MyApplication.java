...
public class MyApplication extends Application {
    ...
    private static DBOffers mDatabase;
    ...
    public synchronized static DBOffers getWritableDatabase() {
        if (mDatabase == null) {
            mDatabase = new DBOffers(getAppContext());
        }
        return mDatabase;
    }
