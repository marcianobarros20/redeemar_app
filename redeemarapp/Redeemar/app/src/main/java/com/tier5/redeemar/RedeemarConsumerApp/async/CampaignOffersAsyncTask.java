...
public class CampaignOffersAsyncTask extends AsyncTask<String, Void, ArrayList<Offer>> {


    private static final String LOGTAG = "CampaignOffersAsync";
    ...
    protected ArrayList<Offer> doInBackground(String... params) {
        ...
        Log.d(LOGTAG, "Inside list campaign offers...");

        String campaign_id = params[0];
