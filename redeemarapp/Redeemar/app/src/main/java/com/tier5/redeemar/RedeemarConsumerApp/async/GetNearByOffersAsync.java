...
public class GetNearByOffersAsync extends AsyncTask<String, Void, ArrayList<User>> {
    ...
    public GetNearByOffersAsync(UsersLoadedListener myComponent){
        this.myComponent = myComponent;
        Log.d(LOGTAG, "Inside GetNearByOffersAsync constructor: "+myComponent);
