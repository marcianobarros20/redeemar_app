...
public class GooglePlusActivity extends Activity implements OnConnectionFailedListener, View.OnClickListener, ConnectionCallbacks {


    private static final String LOGTAG = "GooglePlusActivity";
    ...
    */
    ...
    protected void onActivityResult(int requestCode, int responseCode,
        ...
        Log.d(LOGTAG, "Result Code: "+String.valueOf(responseCode));
        Log.d(LOGTAG, "Result OK: "+RESULT_OK);
        Log.d(LOGTAG, "RC_SIGN_IN: "+String.valueOf(SIGN_IN_CODE));
    ...
    private void resolveSignInError() {
        ...
        if(connection_result != null)
            Log.d(LOGTAG, "mConnectionResult not null");
        else
