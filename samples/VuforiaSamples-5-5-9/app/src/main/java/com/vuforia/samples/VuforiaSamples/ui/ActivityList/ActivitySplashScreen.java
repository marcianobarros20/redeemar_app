...
import com.vuforia.samples.VuforiaSamples.RecyclerViewExample;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        handler.postDelayed(new Runnable()
        {
            ...
            public void run()
            {
                ...
                Intent intent = new Intent(ActivitySplashScreen.this, RecyclerViewExample.class);
                intent.putExtra("ABOUT_TEXT_TITLE", "Scan Logo & Recognize");
