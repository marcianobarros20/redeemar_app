...
import com.vuforia.samples.VuforiaSamples.ActivityExceptionDemo;
import com.vuforia.samples.VuforiaSamples.BrandMainActivity;
import com.vuforia.samples.VuforiaSamples.DisplayFailureActivity;
...
public class CloudReco extends ActivityExceptionDemo implements SampleApplicationControl,
    ...
    public void onVuforiaUpdate(State state)
    {
        ...
        if (statusCode < 0)
        {
            ...
            if (finder.getResultCount() > 0)
            {
                ...
                Log.d(LOGTAG, "Unique Target Id: " + uniqueTargetId);
